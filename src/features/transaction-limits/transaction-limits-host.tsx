...
// Mounted the same way the CRM mounts it: lazy default-export import, then the
// component driven purely by props.
const TransactionLimitsComponent = lazy(() =>
    import('./transaction-limits-component').then((module) => ({
